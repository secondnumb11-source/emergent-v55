...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      system_check_inspect: { Args: never; Returns: Json };
    };
    Enums: {
      app_role: "admin" | "lawyer" | "employee" | "client";
      case_status:
        "open" | "in_study" | "closed_final" | "closed_non_final" | "appealed" | "archived";
      case_type:
        | "labor"
        | "commercial"
        | "execution"
      ...
      notification_status: "draft" | "scheduled" | "sent" | "failed" | "cancelled";
...
export const Constants = {
  ...
  public: {
    Enums: {
      app_role: ["admin", "lawyer", "employee", "client"],
      case_status: ["open", "in_study", "closed_final", "closed_non_final", "appealed", "archived"],
      case_type: [
        "labor",
        "commercial",
        "execution",
